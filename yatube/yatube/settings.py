...
SECRET_KEY = '5umz2s@*+s!y+xq#ueeh^tx%n)-ga_#*kirt$n%ciy_f*+z&un'
...
INSTALLED_APPS = [
    ...
    'core.templatetags.user_filters',  # add application core
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.year.year'  # add some context with year
            ],
            'libraries': {
